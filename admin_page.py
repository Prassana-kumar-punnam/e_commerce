...
def admin_page(root):
    ...
    insert1 = Button(root, text="Insert", font=('italic', 10), bg='white', command=lambda: [insert(), show()])
    insert1.place(x=20, y=150)
    delete1 = Button(root, text='Delete', font=('italic', 10), bg='white', command=lambda: [delete(), show()])
    delete1.place(x=100, y=150)
    update1 = Button(root, text='Update', font=('italic', 10), bg='white', command=lambda: [update(), show()])
    update1.place(x=180, y=150)
    logout = Button(root, text='LogOut', font=('italic', 10), bg='white', command=lambda:admin_to_login(root))
    logout.place(x=150, y=260)
    global data_list
    data_list = Listbox(root)
    data_list.place(x=400, y=30, width=500)
    show()
